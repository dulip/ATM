...
@Component
class CardEjectingState(private val atm: Atm): State {
    ...
    override fun getStateType(): AtmStateType {
        return AtmStateType.CARD_EJECTING
    }

    companion object {
        private val logger = LoggerFactory.getLogger(CardEjectingState::class.java)
    }
}